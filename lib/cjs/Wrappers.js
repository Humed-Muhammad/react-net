...
var OnlineWrapper = function (_a) {
    var children = _a.children, className = _a.className, style = _a.style, _b = _a.pollingIntreval, pollingIntreval = _b === void 0 ? 500 : _b;
    var connection = (0, _1.useConnection)({
